...
```http
GET /webhooks?account_id={account_id}
```
...
```http
POST /webhooks?account_id={account_id}
```
...
```http
GET /webhooks/{endpoint_id}?account_id={account_id}
```
...
```http
PATCH /webhooks/{endpoint_id}?account_id={account_id}
```
...
```http
DELETE /webhooks/{endpoint_id}?account_id={account_id}
```
...
```json
{
  "event_types": [
    ...
    },
    {
      "type": "goal.reached",
      "name": "Goal Reached",
      "description": "Fired when a conversion goal milestone is reached"
    }
  ]
}
```
...
```http
POST /webhooks/{endpoint_id}/test?account_id={account_id}
```
...
```http
POST /webhooks/{endpoint_id}/rotate-secret?account_id={account_id}
```
...
```http
GET /webhooks/{endpoint_id}/deliveries?account_id={account_id}
```
...
```http
GET /webhooks/{endpoint_id}/deliveries/{delivery_id}?account_id={account_id}
```
...
```http
POST /webhooks/{endpoint_id}/deliveries/{delivery_id}/replay?account_id={account_id}
```
...
```http
POST /webhooks/bulk/replay?account_id={account_id}
```
...
```http
GET /webhooks/{endpoint_id}/stats?account_id={account_id}
```
...
```bash
curl -X POST "https://my.sealmetrics.com/api/v1/webhooks/{id}/rotate-secret?account_id=acme" \
