...
description: "40-60% of users ignore cookie banners entirely. Combined with rejection, analytics loses 80-90% of data. Here's why."
canonical_url: "https://docs.sealmetrics.com/blog/cookie-banner-ghosting-data-loss"
lang: "en"
date_generated: "2026-08-09T18:18:16.203Z"
source_hash: "1b49c67a2a933f635431bd9eb32d57453002931fc27a824efbd10e1b6543f2ac"
content_type: "blog"
owner: "content"
llm_priority: "useful"
...
<!-- AUTO-TLDR:START -->
> **TL;DR** — 40-60% of users ignore cookie banners entirely. Combined with rejection, analytics loses 80-90% of data. Here's why.
<!-- AUTO-TLDR:END -->
...
6. **No consent required**: Nothing is stored on or read from the user's device, so temporary session tracking is permitted under GDPR Article 6(1)(f) legitimate interest per CNIL 2020 guidance
...
3. **Balancing test**: Business interests vs. user privacy
   ...
   **Sealmetrics passes balancing test**:
   ...
   - Minimal data retention (24 months maximum)
...
**Regulatory guidance**: CNIL (French data protection authority) explicitly confirmed in 2020 guidance that cookieless analytics tools meeting these criteria can operate under legitimate interest without requiring consent. (CNIL does not certify or approve individual tools — see our [CNIL self-assessment](/compliance/cnil-self-assessment).)
...
**Stop losing 80-90% of your analytics data.** [Try Sealmetrics free for 14 days](https://my.sealmetrics.com/register) and see your complete visitor base for the first time.
...
- [Try Sealmetrics Free](https://my.sealmetrics.com/register)
