...
tags: [gdpr, cookieless-analytics, privacy, legitimate-interest, cnil, compliance]
...
**Processor Compliance**: Our customer-data subprocessor list is minimal — Cloudflare provides CDN and DDoS protection at the edge, under a GDPR-compliant DPA. Our DPA with customers includes the detailed subprocessor listing and notification procedures if processors change.
