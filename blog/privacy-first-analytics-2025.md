...
lang: "en"
date_generated: "2026-09-23T07:22:06.645Z"
...
- No consent requirement: nothing is stored on the device, and the standard browser properties the tracker reads to compute its session identifier rely on the audience-measurement exemption from ePrivacy Article 5(3) ([criteria](/compliance/analytics-cookies-exemption))
...
CNIL's guidance exempts audience measurement from consent when it meets published criteria (own-purpose statistics only, no cross-site tracking, limited retention). Sealmetrics is designed to meet them — see our [CNIL self-assessment](/compliance/cnil-self-assessment). CNIL does not certify or approve individual tools.
