...
tags: [api, alerts, notifications, webhooks, monitoring]
keywords:
  - sealmetrics alerts api
  - "get /alerts/rules traffic drop alert"
  - slack webhook alert notification analytics
  - acknowledge alert history endpoint
  - "cooldown_minutes threshold_value alert rule"
  - get notified when traffic drops
---
