...
tags: [api, authentication, api-keys, jwt, tokens]
keywords:
  - sealmetrics api authentication
  - "x-api-key header sealmetrics"
  - "post /auth/token jwt login"
  - bearer token analytics api
  - "refresh access token sm_refresh_token cookie"
  - how to authenticate sealmetrics api
---
...
:::note Session cookies are not measurement
