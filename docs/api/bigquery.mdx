...
tags: [api, bigquery, integrations, data-warehouse, exports]
keywords:
  - sealmetrics bigquery integration
  - export analytics data to bigquery
  - "post /integrations/bigquery/sync"
  - bigquery backfill historical data
  - "fact_traffic_daily table schema"
...
:::note
BigQuery integration is available on every plan, the [free tier](/api/provision#free-tier) included (Growth, Scale, Enterprise and free tier).
:::
...
:::note Custom properties live inside `properties`, not as columns
