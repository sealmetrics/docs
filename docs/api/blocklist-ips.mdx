...
tags: [api, ip-blocklist, tracking, exclusions, filtering]
keywords:
  - block ip address from tracking
  - sealmetrics ip blocklist api
  - "post /blocklist-ips cidr range"
  - exclude internal office traffic from analytics
  - "max_entries_reached blocklist limit"
  - "ip_or_cidr field"
---
