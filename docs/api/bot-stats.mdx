...
tags: [api, bot-detection, bot-stats, traffic-quality, security]
keywords:
  - sealmetrics bot detection api
  - "get /bot-stats/overview"
  - "get /bot-stats/suspicious-sessions min_score"
  - "known_bot_pattern flag meaning"
  - bot suspicion score distribution
