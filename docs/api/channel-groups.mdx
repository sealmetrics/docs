...
tags: [api, channel-groups, attribution, utm, rules]
keywords:
  - sealmetrics channel groups api
  - custom channel grouping rules utm
  - "post /channel-groups/test a visit"
  - import and export channel rules json
  - "source_pattern medium_pattern regex priority"
  - "rule_is_live 409 conflict draft rule"
---
