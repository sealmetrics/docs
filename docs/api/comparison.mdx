...
tags: [api, comparison, stats, periods, trends]
keywords:
  - compare two periods sealmetrics api
  - "compare=previous parameter stats"
  - "compare=yoy year over year analytics"
  - "traffic_change conversions_change fields"
  - calculate percentage delta from api response
  - "entrances_series_compare time series"
---
