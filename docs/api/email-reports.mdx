...
tags: [api, email-reports, reporting, scheduling, notifications]
keywords:
  - schedule email reports sealmetrics
  - "post /email-reports weekly summary"
  - "post /email-reports/{report_id}/send now"
  - email report recipients and timezone
  - "hour_utc day_of_week report schedule"
  - email report delivery history status
---
