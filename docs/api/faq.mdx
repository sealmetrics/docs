...
tags: [api, faq, troubleshooting, exports, stats]
keywords:
  - "account_id vs site_id sealmetrics api"
  - "site_id rejected on /exports"
  - event level conversions one row per conversion
  - "/exports/stream returns empty file"
  - do jwt tokens need extra scopes
  - "403 with api key on /batch"
---
