...
tags: [api, ai-agents, mcp, openapi, oauth]
keywords:
  - sealmetrics api for agents
  - sealmetrics mcp server
  - analytics api llm
  - openapi spec analytics
  - oauth 2.1 analytics api
---
...
:::note The spec is the authority on types
...
<ApiMethod method="post" path="/batch" />
...
1. <ApiMethod method="post" path="/exports" /> creates a job and returns immediately.
...
:::caution Offset pagination drifts on live data
...
:::caution Writes are not idempotent yet
...
<ApiMethod method="get" path="/health" /> · <ApiMethod method="get" path="/livez" /> · <ApiMethod method="get" path="/readyz" />
