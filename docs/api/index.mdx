...
| `/accounts/{id}` | GET, PATCH, DELETE | Manage specific account |
| `/accounts/{id}/domains` | GET, POST, DELETE | Authorized domains |
| `/accounts/{id}/utm-mappings` | GET, POST, PATCH, DELETE | UTM parameter mappings |
| `/accounts/{id}/users` | GET, POST, PATCH, DELETE | User access management |
| `/accounts/{id}/pixel` | GET | Get tracking pixel code |
| `/accounts/{id}/pixel/status` | GET | Check pixel installation |
...
| Endpoint | Method | Description |
|----------|--------|-------------|
| `/users` | GET, POST | List and create users (admin) |
| `/users/{id}` | GET, PATCH, DELETE | Manage specific user |
| `/users/me/password` | POST | Change current user password |
| `/users/invitations` | GET, POST | Manage user invitations |
...
| Endpoint | Method | Description |
|----------|--------|-------------|
| `/lens/insights` | GET | List AI-generated insights |
| `/lens/insights/summary` | GET | Get insights summary for badges |
| `/lens/insights/{id}` | GET | Get specific insight |
| `/lens/insights/{id}/read` | PATCH | Mark insight as read |
| `/lens/insights/{id}/dismiss` | PATCH | Dismiss insight |
| `/lens/settings` | GET, PATCH | LENS notification settings |

### Channel Groups

| Endpoint | Method | Description |
|----------|--------|-------------|
| `/channel-groups` | GET, POST | List and create channel rules |
| `/channel-groups/{id}` | GET, PATCH, DELETE | Manage channel rule |
| `/channel-groups/stats/channels` | GET | Get channel metrics |
