...
tags: [api, llm-settings, byok, lens-ai, seal-ai]
keywords:
  - lens ai byok api key settings
  - "get /users/me/llm-settings/providers"
  - configure anthropic or openai key in sealmetrics
  - "post /users/me/llm-settings/test connection"
  - set default llm provider for lens
