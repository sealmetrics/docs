...
tags: [api, migration, legacy, authentication, pagination]
keywords:
  - sealmetrics api v1 to v2 migration
  - legacy app.sealmetrics.com api endpoints
  - report_type acquisition replacement
  - skip and limit to page and page_size
  - roas-evolution endpoint replacement
  - set-click offline conversion ingestion
  - date_range to date_from and date_to
---
