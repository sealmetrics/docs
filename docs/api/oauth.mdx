...
tags: [api, oauth, authentication, pkce, third-party-apps]
keywords:
  - sealmetrics oauth
...
:::info Which auth method do I need?
...
<ApiMethod method="post" path="/oauth/register" />
...
<ApiMethod method="get" path="/oauth/authorize" />
...
:::note Invalid client or redirect URI is never redirected
...
<ApiMethod method="post" path="/oauth/token" />
...
<ApiMethod method="post" path="/oauth/revoke" />
