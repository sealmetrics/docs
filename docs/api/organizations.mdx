...
tags: [api, organizations, teams, members, invitations]
keywords:
  - sealmetrics organizations api
  - invite a team member to an organization
  - organization roles owner admin member
  - "/organizations/{slug}/members endpoint"
  - give a member access to a site
  - seal ai token usage per organization
