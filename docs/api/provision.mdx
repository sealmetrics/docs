...
tags: [api, provisioning, headless-signup, ai-agents, onboarding]
keywords:
  - sealmetrics provision api
  - headless analytics signup
  - create analytics account api
  - agent onboarding analytics
---
...
:::info Most people don't call this directly
...
<ApiMethod method="post" path="/provision" />
...
:::caution Handle `api_key` and `claim_url` as secrets
