...
tags: [api, quick-start, authentication, getting-started, stats]
keywords:
  - sealmetrics api quick start
  - how to get a sealmetrics api key
  - where do i find my site id
  - first api call with curl
  - x-api-key header sm_ token
  - /stats/overview example request
...
<ApiMethod method="get" path="/stats/pages" />
...
<ApiMethod method="get" path="/stats/sources" />
...
<ApiMethod method="get" path="/stats/conversions" />
...
<ApiMethod method="get" path="/stats/funnel" />
...
<ApiMethod method="get" path="/stats/geo/countries" />
