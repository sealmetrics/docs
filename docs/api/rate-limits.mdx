...
tags: [api, rate-limits, quotas, errors, plans]
keywords:
  - sealmetrics api rate limits
  - x-ratelimit-limit and x-ratelimit-remaining headers
  - 429 too many requests retry-after
  - api requests per minute per plan
  - rate_limit_exceeded error code
  - stats endpoints limit for api keys
---
...
:::note Where the API reference lives
