...
tags: [api, referrer-mappings, attribution, utm, referrers]
keywords:
  - referrer mappings api
  - map a referrer domain to utm values
  - /referrer-mappings endpoint
  - referrer_pattern and match_type options
  - attribute untagged partner traffic
  - referrer mappings not applied at ingest
---
