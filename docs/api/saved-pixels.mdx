...
tags: [api, saved-pixels, tracking, conversions, gtm]
keywords:
  - saved pixels api
  - generate pixel code for gtm or tealium
  - /saved-pixels endpoint
  - reusable conversion pixel configuration
  - pixel_type pageview conversion microconversion
  - pixel builder conversion types and properties
---
