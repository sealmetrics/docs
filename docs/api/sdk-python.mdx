...
tags: [api, sdk, python, pandas, client-library]
keywords:
  - sealmetrics python sdk
  - pip install sealmetrics does not work
  - python client for the sealmetrics api
  - analytics data into a pandas dataframe
  - sdk magic date shortcuts 30d mtd ytd
  - python sdk error handling ratelimiterror
---

# Python SDK

:::danger Not published yet — `pip install sealmetrics` does not work
...
:::note
There is also a Node.js SDK, but it is **deprecated**, and likewise not published to npm.
:::
