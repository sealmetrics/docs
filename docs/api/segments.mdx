...
tags: [api, segments, filters, saved-segments, reporting]
keywords:
  - sealmetrics segments api
  - create a saved segment with filters
  - /segments endpoint
  - apply a segment to stats endpoints
  - system segments organic-search and paid-search
  - segment operators eq contains in not_in
---
