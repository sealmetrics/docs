...
:::caution API only — there is no dashboard screen for this
...
If you're looking for ready-made client-facing reporting, use the [Looker Studio connector](/platform/settings/integrations/looker-studio) or the [Stats API](/api/stats) instead. Treat this page as a building block, not a shipped feature.
:::
