...
tags: [api, shared-dashboards, embed, sharing, reporting]
keywords:
  - shared dashboards api
  - share_token public dashboard link
  - embed a dashboard in an iframe
  - password protected shared dashboard
  - /shared-dashboards endpoint
  - allowed_domains embed configuration
---
