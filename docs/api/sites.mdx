...
tags: [api, sites, domains, pixel, utm-mappings]
keywords:
  - sealmetrics sites api
  - create a site with the api
  - authorized domains for tracking
  - get the tracking pixel code endpoint
  - check whether the pixel is installed
  - map a custom url parameter to utm_source
---
