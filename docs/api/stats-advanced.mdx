...
tags: [api, stats, utm, landing-pages, channels, microconversions]
keywords:
  - /stats/mediums and /stats/sources endpoints
  - landing pages api metrics
  - channel groups api ga4 style
  - microconversions by conversion_type
  - top campaigns and top terms endpoints
  - period shortcuts 7d 30d mtd ytd
---
