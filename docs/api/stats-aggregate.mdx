...
tags: [api, stats, aggregate, multi-site, portfolio]
keywords:
  - multi site aggregate stats api
  - /stats/aggregate/overview endpoint
  - combine metrics across multiple sites
  - account_ids repeated query parameter
  - superadmin required for aggregation
  - agency dashboard across all properties
---
