...
tags: [api, stats, query, reporting, export]
keywords:
  - sealmetrics stats api
  - query analytics data api
  - /stats/query endpoint
  - multi dimensional analytics query
  - /stats/query/export csv download
  - date_from and date_to request body
  - dimensions metrics and filters in one request
---
...
:::tip Recommended for data exports
