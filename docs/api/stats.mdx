...
tags: [api, stats, analytics, conversions, raw-events]
keywords:
  - sealmetrics stats endpoints
  - /stats/overview traffic metrics
  - /stats/conversions/raw event level data
  - funnel report endpoint
  - custom properties breakdown endpoint
  - traffic by country and device api
---
...
:::warning Use the root-level UTMs, not the ones inside `properties`
