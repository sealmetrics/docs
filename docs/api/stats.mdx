...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/overview?account_id=acme&period=7d&compare=previous"
```
...
| `metrics` | string[] | Metrics to return |
...
| `engaged_entrances` | Sessions with 2+ pageviews |
| `bounce_rate` | Bounce rate percentage |
| `conversions` | Conversion count |
| `revenue` | Total revenue |
| `microconversions` | Microconversion count |
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/pages?account_id=acme&period=30d&page=1&page_size=20" \
  -H "X-API-Key: sm_your_key"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/pages/top?account_id=acme&period=7d&limit=10"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/pages/content-groups?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/landing-pages?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/sources?account_id=acme&period=30d&utm_medium=cpc"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/campaigns?account_id=acme&period=30d&utm_source=google&utm_medium=cpc"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/terms?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/contents?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/referrers?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/devices/types?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/browsers?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/os?account_id=acme&period=30d"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/conversions/types?account_id=acme"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/properties?account_id=acme&period=30d&property_key=product_category" \
  -H "X-API-Key: sm_your_key"
```
...
```bash
curl "https://my.sealmetrics.com/api/v1/stats/properties/keys?account_id=acme"
```
...
def get_traffic_sources(account_id: str, period: str = "30d"):
    response = requests.get(
