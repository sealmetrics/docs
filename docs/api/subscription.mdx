...
tags: [api, subscription, billing, plans, paywall]
keywords:
  - subscription status api
  - /subscription/status endpoint
  - check plan tier from the api
  - trial_ends_at and current_period_end fields
  - is_blocked paywall status
  - free tier event usage in the api
---
