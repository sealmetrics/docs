...
tags: [api, webhooks, events, notifications, security]
keywords:
  - sealmetrics webhooks api
  - verify webhook signature hmac sha256
  - x-sealmetrics-signature header
  - alert.triggered and export.completed events
  - replay a failed webhook delivery
  - rotate webhook secret whsec
  - /webhooks/event-types endpoint
---
