...
|----------------|------------------|
| Single website, < 500K pageviews | Research |
| 2-3 websites, < 2M pageviews | Guard |
| 4+ websites or > 2M pageviews | Growth |
| Agency with many clients | Growth + Account packs |
...
|----------|--------|------------|
| Annual billing | ~17% (2 months free) | Select annual at checkout |
...
All prices are in Euros (€). Charges appear in EUR on your statement; your bank handles conversion if needed.
...
- Ensure you're within new plan's limits before downgrading

### What happens to my data if I downgrade?

Your data is preserved. However:

| If you exceed... | What happens |
|------------------|--------------|
| Account limit | Must archive/delete accounts |
| Pageview limit | Overage charges may apply |
| User limit | Must remove team members |
| Retention limit | Oldest data archived on schedule |
...
| Counts as pageview | Free (doesn't count) |
|--------------------|---------------------|
| Page load | Custom events |
| Virtual pageview (SPA) | Conversions |
| | Micro-conversions |
...
Yes. Go to **Settings → Billing → Usage Limits** to set:
- Maximum overage amount
- Action when limit reached (stop tracking or continue)

### Do unused pageviews roll over?

No. Pageview allowances reset each billing cycle.
...
3. Add payment method to continue after trial
4. No charge if you cancel before trial ends
...
Options:
1. **Upgrade** to a higher plan (Guard → Growth for unlimited)
...
- **Schedule call:** [calendly.com/sealmetrics-sales](https://calendly.com/sealmetrics-sales)
