...
| Data retention | 24 months | 24 months | Custom |
...
| Agent AI Analytics | Yes | Yes | Yes |
| Real-time data (< 2 min) | Yes | Yes | Yes |
...
| LENS Insights | Yes | Yes | Yes |
| AI questions | Unlimited (your own LLM key) | Unlimited (your own LLM key) | Unlimited (your own LLM key) |

LENS AI runs on a bring-your-own-key (BYOK) model: you connect your own LLM provider API key, so there is no per-account question quota and nothing extra to buy. Questions are billed directly by your provider.
