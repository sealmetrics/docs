...
| Agent AI Analytics | - | Coming Soon | Coming Soon |
| Webhooks | - | Yes | Yes |
| Audit logs | - | Yes | Yes |
| Role-based access | Basic | Advanced | Full |
| SSO (SAML) | - | - | Yes |
| SLA | 99% | 99.5% | 99.9% |
| Support | Email + Chat | Priority | Dedicated AM |
...
- Want Agent AI Analytics to track AI bot traffic (coming soon)
...
- **Auto-upgrade** — if you exceed 120% of your limit for 2+ consecutive months, you'll be upgraded to the next tier
...
Tracking continues without interruption. There are no overage charges — your monthly price stays fixed. If you consistently exceed your limit, you'll be automatically upgraded to the next plan tier.
