...
tags: [billing, plans, scale-plan, pricing, webhooks, audit-logs]
keywords:
  - scale plan price
  - scale plan event limit
  - which plan has webhooks and audit logs
  - growth vs scale comparison
  - seal ai private included in scale
---
