...
The Scale plan is designed for multi-brand retailers and larger organizations that need webhooks, audit logs, Agent AI Analytics, and higher event volumes. This is our most popular plan.
...
No overage charges. Your monthly price is fixed at €1,079 (or €899 annual). If you consistently exceed 120% of your 15M event limit for 2+ consecutive months, you'll be moved to an Enterprise plan.
...
- Organizations tracking AI agent traffic with Agent Analytics
