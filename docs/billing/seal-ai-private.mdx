...
description: "Seal AI Private: Sealmetrics' EU-hosted AI add-on — pricing, the 5M monthly token quota, extra token packs, plan availability, and how usage is managed."
---
...
2. **Switch to your own key (BYOK)** — the chat's provider selector lets any user fall back to their own OpenAI, Anthropic, Gemini, or DeepSeek key at any time. See [LLM Providers](/platform/settings/llm).
