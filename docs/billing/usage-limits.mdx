...
**Agent Analytics (coming soon):** AI agent traffic (bots from OpenAI, Anthropic, Google, etc.) will be detected and tracked separately and will **not** count toward your event limit. Agent Analytics will be available on Scale and Enterprise plans.
...
If you exceed **120% of your event limit for 2 or more consecutive months**, you will be automatically upgraded to the next plan tier:

| Current Plan | Auto-Upgrade To | Trigger |
|--------------|----------------|---------|
| Growth (5M) | Scale (15M) | 6M+ events for 2+ months |
| Scale (15M) | Enterprise | 18M+ events for 2+ months |

You'll be notified before any upgrade takes effect.

### Downgrade Suggestions

If your usage drops below **50% of your plan limit for 3 or more consecutive months**, we'll suggest a more cost-effective plan. Downgrades are always optional and never automatic.
...
| 120% (2+ months) | Auto-upgrade notification |
...
3. **Agent Analytics (coming soon)** — AI agent events will be excluded from your event count (Scale and Enterprise)
...
| Want Agent AI Analytics (coming soon) | Scale or Enterprise |
| Need SSO or unlimited events | Contact Enterprise sales |

## FAQ

### Do AI agent events count toward my limit?

When available, Agent Analytics will detect AI agent traffic (bots from OpenAI, Anthropic, Google, etc.) and track them separately. These events will not count toward your monthly event limit. Agent Analytics is coming soon on Scale and Enterprise plans.

### What happens if I hit my limit mid-month?

Tracking continues uninterrupted. There are no overage charges. If you exceed 120% of your limit for 2+ consecutive months, you'll be auto-upgraded to the next tier.
