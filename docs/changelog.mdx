---
date: 2026-02-09
description: Sealmetrics product updates, new reports, API changes, and platform improvements
  — including Sealmetrics V2 (Feb 2026) and the consentless analytics roadmap.
tags:
- changelog
- releases
- updates
