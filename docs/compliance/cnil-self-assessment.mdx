...
**Note:** Sealmetrics goes beyond this requirement — no IP anonymization is needed because the IP is never persisted in the first place.
...
- [Does SealMetrics comply with CNIL guidelines?](/compliance/compliance-overview/cnil-compliance) — the plain-language overview of CNIL consent exemption.
