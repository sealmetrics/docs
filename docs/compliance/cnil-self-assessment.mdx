...
SuperPrivacy mode: Zero storage (isolated hits)
...
and does not track you across websites. You can opt out at any time
at [opt-out link].
```
...
| Easy to access | ✅ Single-click opt-out |
| Persistent opt-out | ✅ Remembered via localStorage |
...
- [ ] SuperPrivacy mode for maximum privacy
