...
tags: [compliance, bot-detection, ip-addresses, legitimate-interest, gdpr]
keywords:
  - how does sealmetrics block bot traffic
  - does sealmetrics store ip addresses
  - bot filtering without storing personal data
  - legitimate interest for ip security processing
  - datacenter blocklist analytics bot detection
category: "Legal"
