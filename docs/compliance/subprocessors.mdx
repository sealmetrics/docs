...
sidebar_position: 8
description: "The complete list of SealMetrics subprocessors — who touches what data, where they are located, and why customer analytics data never leaves the EU."
...
### Not a subprocessor: Hetzner

SealMetrics operates internal infrastructure with **Hetzner** (Germany/Finland) for its **own company workloads** — development, testing, and internal tooling. This infrastructure does **not** process or store customer analytics data, so Hetzner is not a subprocessor of customer analytics data. It is mentioned here for full transparency, because earlier versions of our documentation listed it in a way that could be misread.
...
Note that visitor analytics data contains **no personal identifiers** by design — no IP addresses stored, no cookies, no user IDs, no fingerprints. See [What We Track vs What We Don't](/security-privacy/what-we-track) for the full data inventory.
...
- Is retained for a maximum of 24 months, then automatically deleted (see [Data Location & Retention](/security-privacy/data-location))
...
1. Signs a data processing agreement consistent with GDPR Article 28
2. Processes customer data only within the EU
3. Is bound by confidentiality and security obligations

SealMetrics' own commitments to you as a customer — including the subprocessor engagement terms — are set out in the [SealMetrics Data Processing Agreement (DPA)](https://sealmetrics.com/dpa).

## Changes to this list

If SealMetrics engages a new subprocessor that touches customer data, this page is updated. The terms under which subprocessor changes are communicated to customers are governed by the [DPA](https://sealmetrics.com/dpa).
...
- [Data Location & Retention](/security-privacy/data-location) — where data lives and for how long
- [Data Subject Rights (DSAR)](/compliance/data-subject-rights) — how visitor and account-holder rights requests work
- [What We Track vs What We Don't](/security-privacy/what-we-track) — the full data inventory
- [Is Sealmetrics GDPR, ePrivacy, CCPA, and PECR Compliant?](/compliance/compliance-overview/is-sealmetrics-privacy-compliant) — the multi-regulation compliance summary
