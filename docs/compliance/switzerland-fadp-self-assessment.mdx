...
sidebar_label: "Switzerland FADP Auto-Evaluation"
sidebar_position: 7
...
tags: [compliance, switzerland, fadp, nfadp, self-assessment, data-transfers]
last_update:
  date: 2026-08-12
keywords:
  - is sealmetrics fadp compliant
  - nfadp revdsg web analytics requirements
  - swiss data protection analytics without consent
  - "art. 45c tca terminal equipment rule"
  - fdpic guidance analytics tools
  - where is data hosted for swiss customers
---

# Switzerland FADP Self-Assessment: Sealmetrics
