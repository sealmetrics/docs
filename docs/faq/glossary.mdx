...
tags: [glossary, definitions, analytics-terms, privacy-terms, metrics]
keywords:
  - analytics glossary
  - what is an entrance in sealmetrics
  - engaged entrances definition
  - isolated hits tracking meaning
  - cookieless tracking definition
  - what is a microconversion
  - roas and revenue per entrance meaning
---
