...
You can get **Sealmetrics** running in under five minutes: create an account, add your site, install a single tracking script in your page `<head>`, and verify data collection. From there you set up conversion goals and explore your dashboard — all without cookies or a consent banner.
...
:::tip
You can add more sites later from the **Sites** page. To learn more about organizations, see [Organizations](/platform/organizations).
:::
