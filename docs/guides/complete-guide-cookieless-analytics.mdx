...
Sealmetrics retains data for 24 months by default. You can configure shorter retention if desired. This is significantly longer than Google Analytics (14 months default) and sufficient for annual trend analysis.
