...
import {BarChart, Timeline} from '@site/src/components/PerfChart';
...
<Timeline
  scale={3200}
  axis={['0', '0.5 s', '1 s', '1.5 s', '2 s', '2.5 s', '3 s']}
  rows={[
    {label: 'Adobe', sublabel: 'Launch + AppMeasurement', segs: [
      {t0: 200, t1: 790, color: 'adobe'},
      {t0: 820, t1: 1070, color: 'adobe', opacity: 0.75},
      {t0: 1170, t1: 1960, color: 'adobe', opacity: 0.5},
    ], marks: [{t: 3030, label: 'hit ~3.0 s'}]},
    {label: 'Sealmetrics', sublabel: "via the site's tag chain", segs: [
      {t0: 1520, t1: 1640, color: 'seal'},
    ], marks: [{t: 1750, label: 'hit ~1.75 s'}, {t: 1820}]},
  ]}
/>
...
<BarChart
  ...
  items={[
    ...
    {label: 'Adobe', sublabel: 'Launch container', value: 150000, display: '~150 KB', color: 'adobe'},
    {label: 'Adobe', sublabel: 'AppMeasurement + rules', value: 20000, display: '~20 KB', color: 'adobe'},
  ]}
/>
...
<BarChart
  ...
  items={[
    ...
    {label: 'Adobe', sublabel: 'full stack', value: 730000, display: '~730 KB', color: 'adobe'},
  ]}
/>
