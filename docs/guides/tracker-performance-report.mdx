...
sidebar_position: 4
tags: [tracker, performance, ga4, matomo, piwik-pro, sendbeacon, cookieless-analytics]
...
keywords:
  ...
  - gtag.js size
  - matomo.js size
  - piwik pro ppms.js size
  - matomo vs sealmetrics
  - piwik pro vs sealmetrics
...
<BarChart
  note="Transferred over the network (gzip), 27 August 2026 — true linear scale"
  items={[
    {label: 'Sealmetrics', sublabel: 't.js', value: 1126, display: '1.1 KB', color: 'seal'},
    {label: 'Piwik PRO', sublabel: 'ppms.js', value: 26762, display: '~26 KB', color: 'piwik'},
    {label: 'Matomo', sublabel: 'matomo.js', value: 47354, display: '~46 KB', color: 'matomo'},
    {label: 'GA4', sublabel: 'gtag.js', value: 148679, display: '~145 KB', color: 'ga4'},
  ]}
/>

<BarChart
  note="Uncompressed JavaScript the device has to parse, 27 August 2026"
  items={[
    {label: 'Sealmetrics', value: 1991, display: '2.0 KB', color: 'seal'},
    {label: 'Piwik PRO', value: 69075, display: '~67 KB', color: 'piwik'},
    {label: 'Matomo', value: 156183, display: '~153 KB', color: 'matomo'},
    {label: 'GA4', value: 417429, display: '~408 KB', color: 'ga4'},
  ]}
/>
...
:::note What this pass covers, and what it does not
