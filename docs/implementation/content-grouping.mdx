...
description: "Tag pages with a content group label via the tracker script URL or JavaScript to analyze your site's performance by section in the Pages report."
---
...
```html
<script src="https://t.sealmetrics.com/t.js?id=your-site-id&group=blog" defer></script>
```
...
```javascript
sealmetrics({ group: 'product-category' });
```
...
2. Click on **Pages**
3. Use the content group filter to see metrics by group
4. Each page shows its content group badge
