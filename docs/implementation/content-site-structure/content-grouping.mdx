...
tags: [content-grouping, setup, tracker, reporting, url-patterns]
keywords:
  - how to set up content grouping
  - group parameter in tracking script
  - "t.sealmetrics.com/t.js?id=YOUR_ACCOUNT_ID&group=blog"
  - "sealmetrics({ group: 'blog' })"
  - content group url pattern rules
