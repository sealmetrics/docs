...
tags: [content-grouping, spa, javascript, tracker, wordpress]
keywords:
  - set content group dynamically
  - "sealmetrics({ group: 'blog' })"
  - group url parameter in tracker script
  - content grouping in react and next.js
  - wordpress content group php
