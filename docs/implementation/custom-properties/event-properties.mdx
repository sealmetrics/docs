...
tags: [event-properties, conversions, microconversions, debugging]
keywords:
  - sealmetrics event properties
  - sealmetrics.conv() third parameter
  - sealmetrics.micro() second parameter
  - properties not appearing in reports
  - break down conversions by property
  - event payload x key in devtools
---
