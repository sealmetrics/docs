...
tags: [custom-properties, events, conversions, segmentation]
keywords:
  - sealmetrics custom properties
  - add custom data to conversions
  - sealmetrics.conv() properties
  - sealmetrics.micro() properties
  - property naming best practices
  - event payload size limit 15 kb
  - filter reports by custom property
---
...
<div style={{
  ...
  <a href="./content-groups" style={{
    ...
    <p style={{ margin: '0.5rem 0 0', fontSize: '0.85rem' }}>
      Group pages using the group parameter.
    </p>
  </a>
</div>
