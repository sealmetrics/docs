...
tags: [segmentation, custom-properties, privacy, conversions]
keywords:
  - segment users without cookies
  - customer type property in analytics
  - sealmetrics.conv() user segment
  - sealmetrics.micro() plan type
  - avoid pii in tracking properties
