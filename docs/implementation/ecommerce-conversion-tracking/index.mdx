...
- [Event Properties Guide](/implementation/ecommerce-conversion-tracking/event-properties-guide) - Learn which data fields to send with conversion events for maximum insight
