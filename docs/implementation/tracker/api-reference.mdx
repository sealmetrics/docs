...
Sessions are identified using a browser fingerprint hash. No cookies or storage are used.

### Fingerprint Components

| Component | Example |
|-----------|---------|
| Hostname (root domain) | `example.com` |
| User Agent | `Mozilla/5.0...` |
| Protocol (HTTPS) | `true` |
| Timezone | `Europe/Madrid` |
| Is Mobile | `false` |
| Browser + Version | `chrome94.0` |
| OS + Version | `macos10.15` |
| Language | `en-US` |
| Screen Size | `1920x1080` |
| Hardware Concurrency | `8` |
| Device Memory | `8` |

The fingerprint is hashed using Java's `String.hashCode()` algorithm for consistency with legacy systems.
