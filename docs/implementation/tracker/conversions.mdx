...
tags: [conversions, tracker, ecommerce, revenue, woocommerce]
keywords:
  - sealmetrics.conv()
  - how to track a purchase conversion
  - track leads and signups
  - conversion items array format
  - woocommerce conversion tracking code
  - shopify purchase tracking script
