...
tags: [tracker, javascript, installation, spa, performance]
keywords:
  - sealmetrics javascript tracker
  - t.sealmetrics.com/t.js
  - sealmetrics.conv()
  - sealmetrics.micro()
  - how to install sealmetrics script tag
  - lightweight analytics script size vs ga4
  - sm and _sm global variables
---
