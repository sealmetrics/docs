...
tags: [installation, tracker, setup, google-tag-manager, wordpress]
keywords:
  - how to install sealmetrics tracker
  - sealmetrics script tag
  - t.sealmetrics.com/t.js
  - add tracking code to website
  - "?auto=0 manual pageview"
  - install sealmetrics on wordpress or shopify
  - google tag manager sealmetrics setup
---
