...
tags: [migration, tracker, breaking-changes, legacy, setup]
keywords:
  - sealmetrics tracker v1 to v2 migration
  - update old sealmetrics tracking code
  - "sm('event') new syntax"
  - sealmetrics.conv()
  - adin parameter removed
  - content_grouping replaced by group parameter
  - app.sealmetrics.com/tag/v2/tracker
---
