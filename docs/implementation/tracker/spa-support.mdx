...
tags: [spa, single page application, react, vue, angular, nextjs, tracker]
keywords:
  - how to track spa pageviews
  - spa tracking
  - single page application
  - "?spa=0"
  - "?auto=0"
  - react router pageview tracking
  - react analytics
  - vue analytics
  - angular tracking
  - next.js analytics setup
  - duplicate pageviews on route change
  - hash based routing not tracked
---
