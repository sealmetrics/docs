...
tags: [installation, setup, tutorial, conversions, verification]
keywords:
  - how to install sealmetrics step by step
  - add tracking code to my website
  - where to find my site id
  - verify sealmetrics is working
  - sealmetrics.conv()
  - sealmetrics.micro()
  - tracking not working 204 response
---
