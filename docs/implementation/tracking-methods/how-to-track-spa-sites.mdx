...
3. **Per-route grouping pattern.** See [Option A above](#option-a--suppress-auto-tracking-fire-manually) — calling `sealmetrics({ group: '...' })` after an automatic pageview produces a second event.
