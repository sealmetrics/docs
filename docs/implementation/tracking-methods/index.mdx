...
tags: [tracking-methods, spa, react, ajax, implementation]
keywords:
  - how to track spa sites
  - track ajax form submissions
  - how to track react apps
  - ignore page view
  - client-side routing analytics
...
- [SPA Support](/implementation/tracking-methods/spa-support) - Implement tracking for single-page applications and client-side routing
