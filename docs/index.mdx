...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      // Third-party listings of the PRODUCT go here, not on the Organization
      // node: a directory that reviews the software is identifying the
      // software. Only listings verified to be ours belong in sameAs — a URL
      // here is a claim that the page is about this exact entity.
      "sameAs": [
        "https://www.capterra.com/p/237359/SEAL-Metrics/"
      ]
    })}
  </script>
</Head>
