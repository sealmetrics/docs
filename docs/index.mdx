...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "description": "Consentless web analytics that measures traffic without cookies, consent banners or personal data.",
      "featureList": [
        "Cookieless tracking",
        "GDPR / CNIL / AEPD compliant",
        "Traffic measurement without consent banners",
