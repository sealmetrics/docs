...
:::tip
BigQuery integration is included with **every plan**, the [free tier](/api/provision#free-tier) included (Growth, Scale, Enterprise and free tier). Check your current plan in **Settings → Billing**.
:::
