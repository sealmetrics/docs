...
:::note
For tighter security, you can create a custom role with only these permissions: `bigquery.datasets.create`, `bigquery.datasets.get`, `bigquery.tables.create`, `bigquery.tables.get`, `bigquery.tables.update`, `bigquery.tables.updateData`, `bigquery.jobs.create`.
...
- **Build dashboards**: Connect [Looker Studio](https://lookerstudio.google.com) to your BigQuery dataset for custom visualizations
...
- [Looker Studio Integration](/platform/settings/integrations/looker-studio) — connect the exported dataset to Looker Studio dashboards.
