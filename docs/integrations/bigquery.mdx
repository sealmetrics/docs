...
:::tip
BigQuery integration is available on **Growth plans and above**. Check your current plan in **Settings → Billing**.
:::
...
1. A **SealMetrics Growth plan** or above
...
BigQuery integration is **included at no extra cost** with Growth, Scale, Pro, and Enterprise plans.
