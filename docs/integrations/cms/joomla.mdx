...
tags: [integrations, joomla, cms, virtuemart, hikashop]
keywords:
  - install sealmetrics on joomla
  - sealmetrics joomla plugin
  - joomla analytics without cookies
  - track virtuemart and hikashop purchases
  - joomla form_submit and newsletter_signup tracking
  - j2store purchase tracking joomla
---
...
<a className="button button--primary" href="https://github.com/sealmetrics/modules/releases/latest/download/sealmetrics-joomla.zip">Download Plugin</a>
