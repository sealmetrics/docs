...
- [Understanding Event Properties in Sealmetrics](/implementation/event-tracking) — the model behind the form, search, and 404 microconversions this plugin fires.
