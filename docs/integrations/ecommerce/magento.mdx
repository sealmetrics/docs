...
tags: [integrations, magento, adobe-commerce, ecommerce, conversion-tracking]
keywords:
  - install sealmetrics on magento 2
  - sealmetrics magento module
  - adobe commerce analytics without cookies
  - track magento purchases gdpr
  - magento view_item add_to_cart begin_checkout
  - magento setup upgrade sealmetrics analytics
---
