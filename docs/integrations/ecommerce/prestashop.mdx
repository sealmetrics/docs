...
tags: [integrations, prestashop, ecommerce, conversion-tracking, module]
keywords:
  - install sealmetrics on prestashop
  - sealmetrics prestashop module
  - prestashop analytics without cookies
  - track prestashop purchases gdpr
  - prestashop view_item add_to_cart begin_checkout
  - prestashop order confirmation tracking
---
