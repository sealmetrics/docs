...
tags: [integrations, shopify, ecommerce, conversion-tracking, app-embed]
keywords:
  - install sealmetrics on shopify
  - sealmetrics shopify app embed
  - shopify analytics without cookies
  - track shopify purchases gdpr
  - shopify view_product add_to_cart begin_checkout
  - shopify orders/create purchase webhook
---
...
:::important Purchases are not counted by the pixel
