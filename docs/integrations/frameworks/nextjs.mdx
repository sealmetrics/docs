...
tags: [integrations, nextjs, react, javascript-framework, spa]
keywords:
  - install sealmetrics on next.js
  - "@sealmetrics/nextjs npm package"
  - next.js app router analytics without cookies
  - usesealmetrics hook next.js
  - track view_item add_to_cart in next.js
  - next.js pages router tracking setup
---
