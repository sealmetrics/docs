...
tags: [integrations, nuxt, vue, javascript-framework, spa]
keywords:
  - install sealmetrics on nuxt 3
  - "@sealmetrics/nuxt module"
  - nuxt analytics without cookies
  - usesealmetrics composable nuxt
  - add sealmetrics to nuxt.config.ts
  - track view_item add_to_cart in nuxt
---
