...
:::tip Use the Initialization trigger, not Page View / All Pages
...
| **Users who bounce in <1s** | If the visitor leaves before `gtm.js` runs, the hit never reaches Sealmetrics. Initialization fires almost immediately when the GTM container loads. |
...
Your Sealmetrics Site ID. Find it in your [Sealmetrics dashboard](https://my.sealmetrics.com) under **Settings**.
...
:::warning Data Layer timing with Initialization
