...
- **Super-Privacy mode** — Optional aggregated-data tracking without user attribution
...
Your SealMetrics Account ID. Find it in your [SealMetrics dashboard](https://app.sealmetrics.com) under **Settings**.
...
#### Enable Super-Privacy Tracking

When enabled, tracking works in **aggregated-data mode**:

- No user sessions are tracked
- Conversions are not attributed to traffic sources
- Maximum privacy compliance
- Useful for sensitive industries or strict privacy requirements

**Default behavior (disabled):** Full attribution tracking where conversions are connected to their traffic source (UTM parameters, referrer, etc.).
