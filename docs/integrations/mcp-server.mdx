...
tags: [integrations, mcp, claude, chatgpt, ai-assistant, api]
keywords:
  - connect claude to sealmetrics
  - sealmetrics mcp server url
  - chatgpt cursor codex analytics connector
  - query my analytics in natural language
  - "@sealmetrics/mcp npx setup"
  - sealmetrics api key for mcp
---
...
:::info The hosted endpoint is read-only by design
...
:::tip Want the assistant to draft channel rules?
