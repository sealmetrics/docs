...
- [Understanding Event Properties in Sealmetrics](/implementation/event-tracking) — the event and property model behind the conversion and microconversion tags.
