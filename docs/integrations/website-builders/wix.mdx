...
tags: [integrations, wix, website-builder, wix-stores, velo]
keywords:
  - install sealmetrics on wix
  - wix custom code analytics
  - wix analytics without cookies
  - track wix stores purchases
  - wix velo custom event tracking
  - wix view_item add_to_cart begin_checkout
---
