...
The AI Assistant runs on the LLM provider you configure under **My Account → LLM Providers** (bring-your-own-key). You connect your own Anthropic, OpenAI, DeepSeek, or Gemini API key, and questions are billed by that provider — Sealmetrics does not impose a monthly question quota.
