...
tags: [lens, anomaly-detection, thresholds, seasonality, roadmap]
keywords:
  - how lens anomaly detection works
  - analytics anomaly detection explained
  - traffic drop detection method
  - conversion drop detection
  - statistical baseline and confidence
  - lens automated detection roadmap
---
