...
tags: [lens, anomaly-detection, detection-rules, rule-catalog, roadmap]
keywords:
  - lens detection rules list
  - anomaly detection rule catalog
  - lens rule ids and categories
  - reactive vs proactive rules
  - tracking broken rule
  - planned lens detection library
---

# Detection Rules Catalog

:::caution No rule is active yet
