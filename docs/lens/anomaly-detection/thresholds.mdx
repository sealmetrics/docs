...
tags: [lens, anomaly-detection, thresholds, confidence, seasonality]
keywords:
  - how lens thresholds work
  - anomaly detection threshold explained
  - confidence level analytics detection
  - seasonality threshold adjustment
  - wilson score confidence interval
  - why an anomaly was not flagged
---
