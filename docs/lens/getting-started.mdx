...
The LENS assistant is **bring-your-own-key (BYOK)**: you connect your own LLM provider API key. This means there is no per-account question quota — you ask as much as you like and pay your provider directly.

1. Go to **My Account → LLM Providers**
2. Add an API key for one of the supported providers:
...
3. Mark one provider as your default and save
