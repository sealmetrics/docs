...
tags: [lens, ai-assistant, natural-language, reports, analytics-ai]
keywords:
  - lens ai sealmetrics
  - ask questions about analytics data
  - natural language analytics assistant
  - ai generated analytics reports
  - analytics chatbot gdpr
  - use my own llm key with analytics
---
...
:::caution Automated detection rules are not live yet
