...
tags: [lens, reports, email-alerts, notifications, weekly-digest]
keywords:
  - lens email notifications
  - configure lens alert recipients
  - weekly digest email analytics
  - not receiving lens emails
  - can lens send alerts to slack
  - lens notification settings
---

# Email Alerts

:::caution Insight alerts are not live yet
...
:::note
**Settings → LENS** controls LENS insights and email notifications. This is different from configuring the AI assistant's model provider, which lives under **My Account → LLM Providers**. Don't confuse the two.
:::
