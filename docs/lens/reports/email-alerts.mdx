...
Manage preferences: https://my.sealmetrics.com/settings/notifications
```
...
```json
{
  ...
  "links": {
    "dashboard": "https://my.sealmetrics.com/lens/anomaly/anom_abc123",
    "investigate": "https://my.sealmetrics.com/lens/investigate/anom_abc123"
  }
}
```
