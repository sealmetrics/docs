...
tags: [seal-ai, model-selection, gpt-oss-120b, open-weights, benchmarks]
keywords:
  - which model does seal ai use
  - gpt-oss-120b analytics assistant
  - open weights llm eu sovereign
  - llm model selection audit
  - why not a proprietary llm
  - eu sovereign llm comparison
---
