...
tags: [account-setup, domains, sites, tracking, settings]
keywords:
  - how to add a domain to my site
  - authorize a domain for tracking
  - add a subdomain to sealmetrics
  - site settings domains tab
  - remove a domain from my site
  - no domains configured message
---
