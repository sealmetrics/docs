...
tags: [account-setup, sites, onboarding, organizations]
keywords:
  - how to add a new site
  - create a new site in sealmetrics
  - add another website to my account
  - organization sites new site
  - set timezone and currency when creating a site
---
