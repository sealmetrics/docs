...
tags: [settings, connected-apps, mcp, oauth, security]
keywords:
  - how to revoke an ai assistant access
  - my account connected apps
  - disconnect claude or chatgpt from sealmetrics
  - which apps can read my analytics
  - remote mcp oauth connections
---
...
:::info Not the same as API Keys or sessions
