...
tags: [settings, sites, general, timezone, currency]
keywords:
  - site settings general tab
  - change site name timezone and currency
  - site config settings
  - where are account settings in sealmetrics
  - change the currency shown in reports
---
