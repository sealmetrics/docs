...
tags: [settings, security, 2fa, sessions, account]
keywords:
  - how to enable two factor authentication
  - my account security 2fa
  - backup codes for my sealmetrics login
  - log out all other sessions
  - see which devices are logged into my account
  - disable 2fa
---
...
:::warning Old codes stop working
