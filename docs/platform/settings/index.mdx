...
tags: [settings, overview, organizations, sites, account]
keywords:
  - where are the settings in sealmetrics
  - my account organization and site config menus
  - settings overview
  - which settings can my role access
  - find dashboard configuration options
---
