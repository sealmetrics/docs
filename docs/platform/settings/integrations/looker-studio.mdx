...
description: Connect SealMetrics to Google Looker Studio for custom dashboards and visual reports.
---
...
- Google account with access to [Looker Studio](https://lookerstudio.google.com)
...
:::note Access during gallery review
The SealMetrics Looker Studio connector is currently pending listing in the Looker Studio Partner Connector Gallery. While the listing is being reviewed, your Google account must be granted **Viewer** access to the underlying connector. If the authorization page redirects you to the Looker Studio home with no error, contact us at [support@sealmetrics.com](mailto:support@sealmetrics.com) with the Google email you want whitelisted and we'll grant access within one business day.
:::
...
1. Click the link below to open the SealMetrics connector in Looker Studio:
   ...
   **[Open SealMetrics Connector](https://lookerstudio.google.com/datasources/create?connectorId=AKfycbz0OeJk_X454_DijtnmO12DZeFBRL_u_-anvWX_f5oTvxUDlxdc6yIADlcRzOr2aOPAcg)**
...
- **Blending data**: Use Looker Studio's [data blending](https://support.google.com/looker-studio/answer/9061421) to combine metrics from different report types in a single chart (e.g., join Traffic Sources with Landing Pages by a common dimension).
...
- The Looker Studio data source URL (visible in the address bar)

We aim to respond within one business day.

## Legal

By using the SealMetrics Looker Studio connector, you agree to:

- [SealMetrics Privacy Policy](https://sealmetrics.com/privacy/)
- [SealMetrics Terms of Service](https://sealmetrics.com/terms/)

The connector reads analytics data from your SealMetrics account via the SealMetrics REST API. It does not write to or modify your account. Your API key is stored by Looker Studio in your data source configuration; rotate it from **Settings > API Keys** at any time.
