...
- Google account with access to [Data Studio](https://lookerstudio.google.com)
...
:::tip
Use a dedicated API key for Data Studio so you can rotate it independently without affecting other integrations.
:::
...
1. Go to [Data Studio](https://lookerstudio.google.com) and click **+ Create > Report**
...
- **Blending data**: Use Data Studio's [data blending](https://support.google.com/looker-studio/answer/9061421) to combine metrics from different report types in a single chart (e.g., join Traffic Sources with Landing Pages by a common dimension).
