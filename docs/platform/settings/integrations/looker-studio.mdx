...
tags: [integrations, data-studio, looker-studio, dashboards, reporting]
keywords:
  - how to connect looker studio
  - sealmetrics data studio connector
  - build a dashboard with my analytics data
  - data studio invalid api key error
  - available report types and fields
  - no sites listed in the connector
---
...
:::note Previously called Looker Studio
