...
```json
{
  ...
  "data": {
    ...
    "links": {
      "dashboard": "https://my.sealmetrics.com/lens/anomaly/anom_def456",
      "investigate": "https://my.sealmetrics.com/lens/investigate/anom_def456"
    }
  }
}
```
...
Webhooks are available on Scale and Enterprise plans.
