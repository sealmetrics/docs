...
tags: [settings, llm, byok, seal-ai, lens]
keywords:
  - how to add my own llm api key
  - my account llm providers
  - change the ai model used by lens chat
  - bring your own key anthropic gemini deepseek
  - seal ai private or my own key
  - connection failed when testing the provider
---
...
:::note Not the same as LENS Settings
