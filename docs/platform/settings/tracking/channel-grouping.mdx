...
tags: [settings, tracking, channels, attribution, utm]
keywords:
  - how to create a custom channel
  - site settings channels tab
  - group my traffic into marketing channels
  - test a visit channel rule
  - import channel rules from csv
  - traffic showing as unassigned
---
...
:::note The draft-only limit is enforced by the server
