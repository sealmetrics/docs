...
Content groupings are configured on the **Properties** page:

1. Open **Settings → Properties** in the sidebar
2. Scroll to the **Content Groupings** card

:::info Where rules are stored
...
1. On the **Content Groupings** card, click **Add Rule**
2. Fill in the dialog:

```
Add Content Group Rule
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Both fields are required. Each rule appears in the list showing its name and pattern. Hover over a rule to reveal the **Edit** (pencil) and **Delete** (trash) actions.
