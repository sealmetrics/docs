...
tags: [settings, tracking, custom-dimensions, properties, pixel]
keywords:
  - how to create a custom dimension
  - send custom properties with a conversion
  - site config properties page
  - custom dimension not appearing in reports
  - property value shows as not set
---
...
:::info There is no "dimension manager"
