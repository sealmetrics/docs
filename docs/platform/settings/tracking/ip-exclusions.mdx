...
tags: [settings, tracking, ip-exclusions, internal-traffic, filters]
keywords:
  - how to exclude my own ip from tracking
  - site settings ip exclusions tab
  - stop counting office traffic in my reports
  - exclude a cidr range from analytics
  - ip exclusions versus ip allowlist
  - add my current ip
---
