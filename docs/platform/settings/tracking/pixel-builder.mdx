...
tags: [settings, tracking, pixel-builder, conversions, microconversions]
keywords:
  - how to generate my tracking code
  - organization pixels pixel builder
  - create a conversion pixel snippet
  - gtm and tealium tracking snippet
  - save a reusable pixel configuration
---
...
:::note
The Pixels page is an organization-level page (requires the *Manage Pixels* permission). The same page also shows pixel install status and platform-specific installation guides.
:::
