...
tags: [settings, tracking, utm, attribution, mapping]
keywords:
  - how to map custom url parameters to utm
  - site settings utm mappings tab
  - map campaign id to utm campaign
  - my custom parameters are not in the reports
  - custom parameter attribution without retagging links
  - override utm already in the url
  - google shopping feed utm wrong campaign
  - performance max product feed utm_source product_sync
  - final url suffix cannot remove utm parameters
---
...
:::caution This changes which channel the traffic falls into
