...
tags: [attribution, conversions, payment, referrers, troubleshooting]
keywords:
  - conversions attributed to payment
  - stripe or paypal showing as the traffic source
  - i lost the original source after checkout
  - passthrough referrer for a payment gateway
  - fix wrong conversion attribution
---
