...
tags: [attribution, referrers, payment, conversions, api]
keywords:
  - how to exclude a payment gateway referrer
  - bypass pos or referrer
  - ignore specific referrers in sealmetrics
  - add a passthrough referrer with the api
  - keep the original traffic source after payment
---
