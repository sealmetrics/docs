...
## How to Configure It: Referral Exclusion List

In the production app (`my.sealmetrics.com`), passthrough referrers are managed through the **Referral Exclusion List**:

1. Open the settings menu in the top toolbar and click **Accounts**.
2. In the accounts table, find your account and click the **POS Referral Bypass** action in its row.
3. On the **Referral Exclusion List** screen, type the external domain to exclude (e.g. a payment provider, your SSO/auth domain, or a booking engine) in the **Domain** field.
4. Click **Add referral** to add another domain field if needed.
5. Click **Update** to save.

To remove a domain, click **Delete** next to it.
...
This page is the canonical reference for the passthrough referrer concept. Two related guides cover specific scenarios that use the same Referral Exclusion List:
