...
tags: [user-management, security, ip-allowlist, enterprise, access-control]
keywords:
  - how to restrict dashboard access by ip
  - site settings ip allowlist tab
  - allow only my office ip to log in
