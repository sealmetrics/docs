...
tags: [reports, conversions, microconversions, revenue, ecommerce]
keywords:
  - where do i see my conversions
  - how to track revenue per conversion
  - what is a microconversion
  - average order value report
  - add to cart events report
  - conversions by type
  - online store revenue report
  - which campaigns bring buyers
  - ecommerce sales by device or country
---
...
:::tip Filter to `purchase` for store metrics
