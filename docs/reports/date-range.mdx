...
tags: [reports, date-range, comparison, reporting-period, seasonality]
keywords:
  - how to change the date range
  - compare this month with last year
  - custom date range in reports
  - why is my date range not in the link i shared
  - keyboard shortcut for yesterday
...
:::caution Custom comparison currently compares against the previous period
