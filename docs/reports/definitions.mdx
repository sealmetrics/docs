...
Complete reference of all metrics used in Sealmetrics reports.
...
For technical terms related to privacy, tracking technology, and compliance, see the [Technical Glossary](/faq/glossary).
...
| Aspect | Description |
|--------|-------------|
| Identification | Based on browser fingerprinting (cookieless) |
...
**Definition:** The origin of traffic as defined by the `utm_source` parameter.
...
**Definition:** The marketing medium as defined by the `utm_medium` parameter.
...
**Definition:** The specific campaign name as defined by the `utm_campaign` parameter.

**Examples:**
- `spring-sale-2025`
- `brand-awareness-q1`
- `product-launch-widget`

### Referrer

**Definition:** The domain of the website that linked to your site (when no UTM parameters present).

| Aspect | Description |
|--------|-------------|
| Detection | From HTTP Referer header |
| When shown | Traffic without UTM parameters |
| Format | Domain only (not full URL) |

## Page Metrics

### Page Path

**Definition:** The URL path of a page, excluding domain.

**Example:** For `https://example.com/products/widget`, the path is `/products/widget`.

### Page Title

**Definition:** The HTML title of a page (from `<title>` tag).

**Note:** If title changes after page load, the initial title is recorded.

### Landing Page

**Definition:** The first page a user views when starting a session.

| Aspect | Description |
|--------|-------------|
| Importance | First impression of your site |
| Analysis | Landing page bounce rate is critical |
| Optimization | Focus on high-traffic landing pages |

### Content Group

**Definition:** A user-defined category for grouping related pages.
...
See [Content Grouping](/implementation/content-site-structure/content-grouping) for setup.

## Device Metrics

### Device Type

**Definition:** The category of device used to access your site.
...
**Definition:** The web browser used to access your site.
...
Includes version number when available.

### Operating System

**Definition:** The operating system of the user's device.
...
**Definition:** The country where the user is located.

| Aspect | Description |
|--------|-------------|
| Detection | Based on IP geolocation |
| Accuracy | Country-level is highly accurate |
| Privacy | City-level not tracked |
