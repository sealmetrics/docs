...
tags: [reports, devices, browsers, operating-systems, mobile, ecommerce]
keywords:
  - how much of my traffic is mobile
  - traffic by browser report
  - mobile vs desktop conversion rate
  - why does safari perform differently
  - which operating systems do my visitors use
  - is my mobile checkout losing sales
  - revenue by device ecommerce
  - which browser has zero purchases
---
