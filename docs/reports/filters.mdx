...
tags: [reports, filters, segments, geography, devices]
keywords:
  - how to filter my analytics data
  - save a segment in sealmetrics
  - filter traffic by country and device
  - why did my filters disappear
  - find pages with a high bounce rate
---
