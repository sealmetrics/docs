...
tags: [reports, funnel, ecommerce, drop-off, checkout, utm]
keywords:
  - where do i lose customers in checkout
  - ecommerce conversion funnel report
  - add to cart to purchase drop off
  - can i build a custom funnel
  - why is a funnel step missing
...
:::info Steps are aggregate counts, not user paths
...
:::caution Rows that differ only by UTM term
