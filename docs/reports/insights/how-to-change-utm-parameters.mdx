...
tags: [utm, campaigns, attribution, settings, utm-mappings]
keywords:
  - use custom parameter names instead of utm
  - map campaign_id to utm_campaign
  - change utm parameters in sealmetrics
  - my campaign urls use different parameters
  - where are the utm mappings settings
sidebar_position: 5
---
