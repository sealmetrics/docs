...
tags: [google-ads, campaigns, utm, attribution, paid-search]
keywords:
  - track google ads in sealmetrics
  - google ads utm tracking template
  - valuetrack parameters utm_term
  - gclid attribution without cookies
  - google ads campaign not showing in reports
  - final url suffix sealmetrics
---
...
:::note
`{_term}` in the Shopping template is a **custom parameter**, not a built-in one. Google only fills it if you have defined a custom parameter named `term` in your Google Ads account, campaign, or ad group. If it is undefined, the value arrives empty and the Terms tab shows **(not set)**.
:::
