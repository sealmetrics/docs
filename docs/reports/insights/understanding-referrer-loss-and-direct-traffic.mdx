...
tags: [referrer-loss, direct-traffic, attribution, troubleshooting, redirects]
keywords:
  - why is my direct traffic so high
  - the referrer is missing from my traffic
  - traffic from email apps shows as direct
  - redirects are losing my traffic source
  - referrer policy is hiding my traffic source
---
