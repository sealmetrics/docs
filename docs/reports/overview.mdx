...
tags: [reports, overview, dashboard, entrances, bounce-rate, revenue, ecommerce]
keywords:
  - how is my site doing today
  - is my tracking still receiving hits
  - where do i see entrances and pageviews
  - why did my traffic drop today
  - compare traffic with the previous period
  - main analytics dashboard
  - how much revenue did my online store make today
  - which traffic sources bring sales to my store
  - landing pages with traffic but no sales
---
...
:::note Stat cards always compare with the previous period
...
:::caution Segment and the chart's comparison line
