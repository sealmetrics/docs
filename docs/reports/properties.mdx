...
tags: [reports, properties, custom-properties, attribution, ecommerce]
keywords:
  - analyze custom properties by campaign
  - which campaigns sell each product category
  - plan type by traffic source
  - conversion properties report
  - no properties found in my report
  - which products does each traffic source sell
  - product category sales by utm campaign
