...
tags: [reports, traffic-sources, utm, channels, campaigns, referrers, ecommerce]
keywords:
  - where is my traffic coming from
  - utm campaign report sealmetrics
  - channel grouping like ga4
  - which websites are linking to me
  - paid search vs organic search traffic
  - traffic from chatgpt and ai assistants
  - which campaigns bring sales to my online store
  - revenue by traffic source ecommerce
  - sales attributed to paypal or payment gateway
---
...
:::info Referral traffic appears here as domains (July 2026)
