---
description: What consentless analytics is, the four non-identifying variables Sealmetrics
...
Sealmetrics measures aggregate behaviour instead of individuals, recording four non-identifying variables: timestamp, user agent, current URL and referral URL. Every visit, page view and conversion is counted and attributed to its source. The deliberate trade-off: returning visitors cannot be identified, because doing so would require a persistent identifier.
