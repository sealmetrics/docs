---
description: The mechanics of consentless tracking — four non-identifying variables,
  isolated hits, a short-lived session marker, and EU-only aggregate storage.
keywords:
- how consentless tracking works
- consentless analytics architecture
