---
description: The mechanics of consentless tracking — a small set of non-identifying fields,
  isolated hits, a daily re-keyed session identifier, and EU-only aggregate storage.
keywords:
