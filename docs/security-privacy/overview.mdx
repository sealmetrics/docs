...
- The user agent is stored alongside the hit for the standard 24-month retention; it is **never joined with a personal identifier** (there isn't one) and never used to reconstruct a user's history across sessions
...
**Data retention:** Up to 24 months without requiring user consent.
