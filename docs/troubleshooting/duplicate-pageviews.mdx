...
sidebar_label: Duplicate Pageviews
...
tags: [troubleshooting, pageviews, duplicates, spa, gtm]
keywords:
  - duplicate pageviews sealmetrics
  - two pageviews per load
  - double counting pageviews
  - spa double pageview
  - auto=0 spa=0
  - gtm and hardcoded tracker
---
