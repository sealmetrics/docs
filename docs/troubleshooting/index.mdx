...
description: "Diagnose and fix common SealMetrics issues: verify tracker installation in DevTools, confirm real-time data collection, and resolve missing data."
---
