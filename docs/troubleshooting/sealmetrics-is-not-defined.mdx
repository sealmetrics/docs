...
tags: [troubleshooting, tracker, adblock, gtm, stub, referenceerror]
keywords:
  - sealmetrics is not defined
  - ReferenceError sealmetrics
  - tracker blocked
  - ad blocker
  - ublock origin
  - brave shields
...
```javascript
sealmetrics.micro("browsing_peticion_cita_paso_1", { ... });
```
