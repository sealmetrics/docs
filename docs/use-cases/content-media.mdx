...
- [Understanding Event Properties in Sealmetrics](/implementation/event-tracking) — tag engagement events with article, author, and category properties
- [Installation](/implementation/tracker/installation) — add the tracking script to your publishing platform
- [Content Grouping](/implementation/content-grouping) — organize articles, categories, and video into groups for reporting
