...
tags: [use-cases, ecommerce, conversion-tracking, revenue, checkout-funnel]
keywords:
  - ecommerce analytics without cookies
  - track online store purchases
  - shopify conversion tracking without consent
  - woocommerce purchase tracking
  - track add to cart events
  - checkout funnel and cart abandonment tracking
---
...
:::tip
`items` is an array of JavaScript objects inside the properties parameter. Each object supports free-form fields: `product_name`, `product_id`, `price`, `quantity`, `category`, `brand`, `variant`, `sku`, etc.
:::
