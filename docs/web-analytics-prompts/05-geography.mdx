...
tags: [geography, country, segmentation, geo, sealmetrics-mcp, hotels, ecommerce]
keywords:
...
## WAP-028 — Country revenue with monthly trend
...
## WAP-029 — Top 5 fastest-growing entrance countries
...
## WAP-030 — Countries with traffic but zero conversions
...
## WAP-031 — Best country per active campaign
...
## WAP-032 — Hotels: direct booking countries vs OTA-coming countries
...
## WAP-033 — Geo conversion mismatch (under-converted markets)
