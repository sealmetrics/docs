...
## WAP-096 — Click-to-entrance discrepancy
...
## WAP-097 — ROAS as Google reports vs real
...
## WAP-099 — Wasted spend on bot traffic
...
## WAP-100 — High CTR but low conversion landings
...
## WAP-101 — Device performance: Google Ads vs SealMetrics
...
## WAP-102 — Search Lost IS opportunity check
...
## WAP-104 — Brand vs non-brand cannibalization
...
## WAP-105 — Quality Score vs real CR
