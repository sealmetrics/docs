...
tags: [search-console, gsc, seo, queries, ranking, multi-mcp, sealmetrics-mcp, gsc-mcp]
keywords:
  - gsc seo analysis
...
## WAP-115 — High-impression queries with low real CR
...
## WAP-116 — Top GSC pages with poor CR
...
## WAP-117 — Queries with GSC clicks but no SealMetrics entrances
...
## WAP-119 — CTR per query vs engagement quality
...
## WAP-120 — Paid vs organic on shared keywords
...
## WAP-121 — Strong rankings without paid push
...
## WAP-122 — Lost rankings revenue impact
...
## WAP-123 — Pages indexed but no traffic
...
## WAP-124 — Cannibalization across URLs
