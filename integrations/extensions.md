...
- **[AI Agentic Package (Claude & Codex)](/integrations/agentic-package)** — create a free account from the chat and place your pixel, step by step.
- **[MCP Server for AI Assistants](/integrations/mcp-server)** — manual setup for Claude Code, Codex, Cursor, and other MCP clients (using an API key + `npx`).

**Tip:**
- **Claude Desktop, easiest path** → this extension.
- **Any other client (Claude Code, Codex, Cursor, VS Code…)** → [MCP Server](/integrations/mcp-server).
...
- **Claude Desktop** `0.10.0` or newer (latest recommended — [download](https://claude.ai/download)).
...
That's it. Next, configure it (below) or jump straight to [creating an account from the chat](/integrations/agentic-package#step-2-create-your-account-from-the-chat).
...
More fixes in the [Agentic Package troubleshooting](/integrations/agentic-package#troubleshooting) and [MCP Server troubleshooting](/integrations/mcp-server#troubleshooting) sections.

---

## Resources

- **Create an account from the chat**: [AI Agentic Package](/integrations/agentic-package)
- **Other MCP clients (Codex, Cursor, VS Code…)**: [MCP Server](/integrations/mcp-server)
- **npm package**: [@sealmetrics/mcp](https://www.npmjs.com/package/@sealmetrics/mcp)
