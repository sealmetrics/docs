...
source_hash: "e33f1a4b1631a77ae6934e7a77d560ed0b176075044945c557130866ac78eb9f"
...
| `country` | string | Filter by country: ISO-3166-1 alpha-2 code or `Unknown` — see [below](#filtering-by-country) | `ES`, `US`, `Unknown` |
...
`Unknown` is the value stored when the visitor's browser timezone maps to no country. The country always comes from the timezone, never from the IP address; see [country detection](/security-privacy/country-detection). `country=Unknown` isolates that traffic. To see which codes have traffic, call [`GET /stats/geo/countries`](/api/stats#get-statsgeocountries).
