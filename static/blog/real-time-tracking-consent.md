...
Canonical page: https://docs.sealmetrics.com/blog/real-time-tracking-consent
...
Plausible's cookieless, first-party architecture is generally regarded as aligning with the CNIL's exemption criteria. Note that the CNIL retired its list of exemption-eligible tools in July 2025, replacing it with a self-assessment framework, so no tool — Plausible or Sealmetrics — can point to a current CNIL listing as proof. Whether Plausible fully satisfies the stricter AEPD daily aggregation rule depends on which specific features are used and how the data is stored.
...
For details on Sealmetrics' compliance architecture, see the [compliance overview](/compliance) and [consentless analytics documentation](/security-privacy/consentless-analytics).
