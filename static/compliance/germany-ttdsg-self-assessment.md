...
1. Its standard configuration **stores no information on, and reads no stored information from, the end user's terminal equipment**, so the consent requirement of **§25(1) TDDDG is not triggered**
2. Stored visitor analytics data **contains no personal data and no identifiers**
