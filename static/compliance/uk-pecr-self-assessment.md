...
source_file: "compliance/uk-pecr-self-assessment.mdx"
publisher: "Sealmetrics"
---

# UK PECR Self-Assessment: Sealmetrics Compliance

Canonical page: https://docs.sealmetrics.com/compliance/uk-pecr-self-assessment

*Reviewed: 12 August 2026. This is a self-assessment; no supervisory authority certifies analytics tools.*\
Sealmetrics is self-assessed as meeting all four conditions of the UK analytics exemption under the **Privacy and Electronic Communications Regulations (PECR)** as amended by the **Data Use and Access Act 2025**, effective **February 5, 2026**: the sole purpose of aggregate statistics, clear user information, a simple free opt-out, and no advertising use. This document details each condition, the permitted activities and the configuration required for UK users.
...
## Does Sealmetrics meet the UK analytics exemption? {#executive-summary}
...
1. **Browser-level blocking** - Users can block the tracking script using:
   - Browser privacy settings
   - Ad blockers (uBlock Origin, etc.)
   - Privacy extensions

2. **Publisher-implemented opt-out** - Site owners can implement their own opt-out:
```html
...
- [Is Sealmetrics GDPR, ePrivacy, CCPA, and PECR Compliant?](/compliance/compliance-overview/is-sealmetrics-privacy-compliant) — the overall multi-regulation compliance summary.
- [CNIL Self-Assessment: Sealmetrics Compliance](/compliance/cnil-self-assessment) — the equivalent self-assessment for France.
- [Analytics Cookies: Consent Exemption Requirements](/compliance/analytics-cookies-exemption) — the analytics exemption conditions across EU DPAs.
- [GDPR and Cookieless Analytics](/compliance/gdpr-cookieless-analytics) — the cookieless basis that satisfies UK GDPR too.
- [Why Sealmetrics Can Measure Without Consent](/security-privacy/why-no-consent) — the model behind the PECR exemption.
