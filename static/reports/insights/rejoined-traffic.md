...
Canonical page: https://docs.sealmetrics.com/reports/insights/rejoined-traffic
...
When a user returns after the session window expires (**2 hours of inactivity** by default), Sealmetrics:
...
## Why a Session Window Threshold?
...
Examples of activity gaps that exceed the session window:
...
- Applies the session window threshold (2 hours by default)
...
- [How Attribution Accuracy Works](/reports/insights/attribution-accuracy) — Where the 2-hour session window comes from
- [Understanding Direct Traffic in Sealmetrics](/reports/insights/direct-traffic) — Why rejoined keeps direct clean
- [Referral vs Direct Traffic](/reports/insights/referral-vs-direct-traffic) — How each session's source is classified
- [Sources Report](/reports/sources) — See rejoined traffic by original channel
