...
source_file: "security-privacy/overview.mdx"
publisher: "SealMetrics"
---

# Security & Privacy

Canonical page: https://docs.sealmetrics.com/security-privacy/overview
...
- **No IP addresses** - Never persisted in the analytics database; used only transiently server-side for anti-abuse protection
...
- Unique domain (my.sealmetrics.com)
...
- Fixed, predictable retention windows
...
- **DPA included, public and ready to sign** - Short-lived pseudonymous analytics data deserves a proper Article 28 contract, so we provide one out of the box (your DPO will ask for it anyway): [sealmetrics.com/dpa](https://sealmetrics.com/dpa/)
- **One paragraph in your privacy policy** - The AEPD audience-measurement guide asks you to inform users via your privacy policy — we provide ready-made wording, so this takes minutes
- **No consent management** - No consent banner required for cookieless analytics
...
- [Why Sealmetrics Can Measure Without Consent](/security-privacy/why-no-consent) — the legal basis for consentless measurement
- [What We Track vs What We Don't](/security-privacy/what-we-track) — the exhaustive list of collected and excluded data
- [Privacy by Design Principles](/security-privacy/privacy-by-design) — the seven principles behind the architecture
- [Frequently Asked Questions](/faq/privacy-security) — common privacy and security questions answered
- [Is Sealmetrics GDPR, ePrivacy, CCPA, and PECR Compliant?](/compliance/compliance-overview/is-sealmetrics-privacy-compliant) — compliance across major regulations
