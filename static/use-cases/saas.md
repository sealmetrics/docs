...
owner: "docs"
llm_priority: "useful"
source_file: "use-cases/saas.mdx"
...
|--------|------------------|---------------|
| **Visitor → Trial** | signup / entrances | pageview, signup |
...
- [Understanding Event Properties in Sealmetrics](/implementation/custom-properties/event-properties) — enrich signup, onboarding, and upgrade events with custom properties
- [Installation](/implementation/tracker/installation) — add the tracking script to your marketing site and app
- [Funnel Report](/reports/funnel) — visualize the trial-to-paid and onboarding funnels
- [Conversions Report](/reports/conversions) — analyze subscriptions, upgrades, and MRR by channel
- [Lead Generation](/use-cases/lead-generation) — a sibling guide for tracking demo requests and B2B forms
