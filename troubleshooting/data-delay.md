---
title: "Data Taking Longer Than Expected to Appear"
description: "How long data normally takes to reach Sealmetrics reports (seconds, not hours), how to verify with the Last hit timestamp on Overview, and what to check when it seems delayed."
canonical_url: "https://docs.sealmetrics.com/troubleshooting/data-delay"
lang: "en"
date_generated: "2026-08-09T18:18:16.203Z"
source_hash: "f56f930287e79f8b0612cf685e18c984af9fe277bc712e1562eaf167251f82b5"
...
Canonical page: https://docs.sealmetrics.com/troubleshooting/data-delay
...
1. Open the **Overview** report for the site.
2. Visit your website in another tab (with no ad blocker interfering).
3. Reload the Overview: **Last hit** should move to "seconds ago".
...
- **Date range.** Make sure the selected period includes **today** — several default ranges end yesterday. See [Date Range](/reports/date-range).
- **Timezone.** "Today" is defined by the **site's timezone**, not yours. Near midnight, your test hit may fall on a different report day than you expect — see [Report dates don't match another tool](/troubleshooting/dates-timezone-mismatch).
...
1. **The beacon never left the browser** — script blocked or missing. See [Quick Diagnostics](/troubleshooting#quick-diagnostics) and [CSP errors](/troubleshooting/csp-errors-domains-to-allow).
2. **The tag is gated behind consent** in GTM — see [GTM Consent Mode blocking](/troubleshooting/gtm-consent-mode-blocking).
3. **The page's domain is not authorized** for the site — the hit is rejected silently. See [Unauthorized domain](/troubleshooting/unauthorized-domain).
4. **Your test traffic is being filtered as a bot** — automated or scripted visits don't count. See [Test traffic blocked as bot](/troubleshooting/test-traffic-blocked-as-bot).
...
- [See Your Data Flow](/getting-started/see-your-data-flow) — what a healthy first-data experience looks like.
- [Overview Report](/reports/overview) — where the Last hit timestamp lives.
- [Quick Start — verification](/getting-started/quick-start) — the standard install verification steps.
